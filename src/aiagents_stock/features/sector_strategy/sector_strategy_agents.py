...
class SectorStrategyAgents:
    ...
    def __init__(self, model="deepseek-chat"):
        ...
        logger.info(f"[智策] AI智能体系统初始化 (模型: {model})")
...
"""
        ...
        messages = [
            {
                "role": "system",
                "content": "你是一名资深的宏观策略分析师，擅长从宏观经济、政策和新闻事件中把握市场脉搏。",
            },
...
"""
    ...
    def fund_flow_analyst_agent(
        self, fund_flow_data: Dict, north_flow_data: Dict, sectors_data: Dict
    ) -> Dict[str, Any]:
        """
...
"""
    ...
    def market_sentiment_decoder_agent(
        self, market_data: Dict, sectors_data: Dict, concepts_data: Dict
    ) -> Dict[str, Any]:
        """
        市场情绪解码员 - 从多维度解读市场情绪
