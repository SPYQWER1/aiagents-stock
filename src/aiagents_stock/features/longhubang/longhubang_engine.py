...
from aiagents_stock.features.longhubang.longhubang_agents import LonghubangAgents
from aiagents_stock.features.longhubang.longhubang_data import LonghubangDataFetcher
from aiagents_stock.features.longhubang.longhubang_db import LonghubangDatabase
from aiagents_stock.features.longhubang.longhubang_scoring import LonghubangScoring
...
class LonghubangEngine:
    ...
    def run_comprehensive_analysis(self, date=None, days=1) -> Dict[str, Any]:
        ...
        try:
            ...
            recommended_stocks = self._extract_recommended_stocks(
                chief_result.get("analysis", ""), stock_result.get("analysis", ""), summary
            )
    ...
    def _generate_final_report(self, agents_results: Dict, summary: Dict, recommended_stocks: List[Dict]) -> Dict:
        """
        生成最终报告
