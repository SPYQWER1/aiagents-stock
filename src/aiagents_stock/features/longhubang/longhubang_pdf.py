    ...
    def _get_styles(self) -> dict:
        ...
        custom_styles = {
            ...
            "Small": ParagraphStyle(
                "CustomSmall", parent=styles["Normal"], fontSize=9, leading=12, fontName=self.chinese_font
            ),
        }
    ...
    def _create_data_overview(self, data: dict) -> list:
        ...
        if summary.get("top_stocks"):
            ...
            for idx, stock in enumerate(summary["top_stocks"][:20], 1):
                table_data.append([str(idx), stock["code"], stock["name"], f"{stock['net_inflow']:,.2f}"])
    ...
    test_data = {
        ...
        "data_info": {
            ...
            "summary": {
                ...
                "top_youzi": {"92科比": 14455321, "赵老哥": 12000000},
                "top_stocks": [{"code": "001337", "name": "四川黄金", "net_inflow": 14455321}],
                "hot_concepts": {"黄金概念": 10, "新能源": 8},
            },
        },
        "recommended_stocks": [
            {
        ...
        "agents_analysis": {"chief": {"analysis": "综合分析显示..."}},
    }
